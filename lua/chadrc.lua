...
vim.o.keymodel = "startsel,stopsel" -- Allow Shift + Arrow keys to select text

-- Move forward by one character (Ctrl + Right)
vim.api.nvim_set_keymap("n", "<C-Right>", "l", { noremap = true, silent = true })

-- Move backward by one character (Ctrl + Left)
vim.api.nvim_set_keymap("n", "<C-Left>", "h", { noremap = true, silent = true })
